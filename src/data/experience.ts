...
export const experience: Experience[] = [
  {
    ...
    logo: "/assets/logos/check24_logo.png",
  ...
  },
  {
    ...
    endDate: "2026-06",
    highlights: [
      "Conducted research at the intersection of software metrics and mobile application security, resulting in two published conference papers.",
      "MIRROR: A Dataset of Structural Metrics for Repackaged Android Apps — published at FORGE 2026.",
      "AndroMetric: Bridging Multi-Dimensional Software Metrics and Mobile Application Security — published at MSR 2026.",
    ],
  },
  {
    id: "vaudience",
